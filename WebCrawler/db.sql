...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`crawler` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
CREATE TABLE `products` (
  ...
  `resouce_link` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
